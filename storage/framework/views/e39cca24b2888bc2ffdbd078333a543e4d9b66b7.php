                            ...
                            <table class="table">
                                ...
                                <?php $__currentLoopData = $lists; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $data): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <tr>
                                        ...
                                        <td>
                                            <button type="button" class="btn btn-outline-primary edit-button" data-id="<?php echo e($data->id); ?>">Edit</button>
                                            <button type="button" class="btn btn-outline-danger delete-button" data-id="<?php echo e($data->id); ?>">Delete</button>
                                        </td>
                                    </tr>
...
<?php /**PATH /Users/apple/Desktop/project/gedik-case/todo-case/resources/views/todo/home.blade.php ENDPATH**/ ?>